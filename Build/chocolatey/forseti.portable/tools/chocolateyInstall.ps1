...
$packageName = 'forseti.portable' # arbitrary name for the package, used in messages
$url = 'http://downloads.sourceforge.net/project/forseti/Continuous/Forseti.Console.zip?' # download url
