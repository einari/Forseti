...
{
	public class when_applying_a_file : given.a_configuration_file_reader_and_a_configure_instance
	{
		static Mock<IFile>	file_mock;
		
		Establish context = () => file_mock = new Mock<IFile>();
		
		Because of = () => reader.Apply(configure_mock.Object, file_mock.Object);
